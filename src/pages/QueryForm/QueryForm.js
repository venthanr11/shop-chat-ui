    ...
    <QueryFormContainer>
      <Flex width={1} flexDirection="column">
        ...
        <Box width={3/4} mx="auto" mt={3}>
          <Input name="title" placeholder="Product Title" label="Product Title"/>
        </Box>
        <Box width={3/4} mx="auto" mt={4}>
          <Input name="description" placeholder="Product Description" label="Product Description"/>
        </Box>
        <Box width={3/4} mx="auto" mt={4}>
          <Dropdown name="category" placeholder="Product Category" label="Product Category" items={items}/>
        </Box>
      </Flex>
